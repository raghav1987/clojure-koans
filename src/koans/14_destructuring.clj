...
(meditations
  ...
  (= "123 Test Lane, Testerville, TX"
     (let [{street-address :street-address, city :city, state :state} test-address]
       (apply str(interpose ", "(reverse (sort-by count(vals test-address)))))))
  ...
  (= "Test Testerson, 123 Test Lane, Testerville, TX"
     (  (fn [[test testerton] {:keys [street-address city state]}] (apply str(interpose ", "(cons (str test " " testerton) (list street-address city state))))) ["Test" "Testerson"] test-address)))
